...
model.add(Embedding(input_dim=28, output_dim=11, input_length=5))   # 이 뒤는 바로 flatten 을 쓸 수 있다. (None, 5, 11) 로 받아서

# model.add(Embedding(28, 11))   # 이 뒤는 flatten 을 쓸 수 없다. (None, None, 11) 로 받아서
