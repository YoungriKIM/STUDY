...
for q in qlist:
    ...
    filepath = '../data/modelcheckpoint/dacon_train_0121_1_{epoch:02d}-{val_loss:.4f}.hdf5'
...
subfile.to_csv('../data/csv/dacon1/sub_1021_2.csv', index=False)
'''
#===================================================================
# 예측값으로 그래프 그리기
...
graph = pd.read_csv('../data/csv/dacon1/sub_1021_2.csv')
plot = graph.plot()
