...
# x, y 데이터 지정
# 액면분할 시점 : 1740
x = df0114.iloc[0:2399, [0,1,2,3,4,5]]
...
hist = model.fit(x_train, y_train, epochs=500, batch_size=1, validation_data=(x_val, y_val), verbose=1, callbacks=[stop])#, check])
...
# [0:2399, [0,1,2,3,4,5]]       mse:  630,387.8125
# mse:  543,281.375
# mse:  568,169.25
# mae:  523.4016723632812
# 89,336.2890625
# 1/15일 삼성주식 종가는 89,336.2890625 입니다.