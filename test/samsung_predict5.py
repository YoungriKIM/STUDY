...
hist = model.fit(x_train, y_train, epochs=500, batch_size=2, validation_data=(x_val, y_val), verbose=1, callbacks=[stop])#, check])
...
# 83
# mse:  853,660.3125
# mae:  679.1766357421875
# 89,109.4453125
# 1/15일 삼성주식 종가는 89,109.4453125 입니다.