# 사이킷런의 boston, diabetes, cancer, iris, wine
# 텐서플로우의 mnist, fashion, cifar10, cifar100
...
np.save('../data/npyboston_x.npy', arr=boston_x)
...
np.save('./data/fashion_x_train.npy', arr = f_x_train)
np.save('./data/fashion_y_train.npy', arr = f_y_train)
np.save('./data/fashion_x_test.npy', arr = f_x_test)
np.save('./data/fashion_y_test.npy', arr = f_y_test)

#8. cifar10
(c_x_train, c_y_train), (c_x_test, c_y_test) = cifar10.load_data()
np.save('../data/npy/cifar10_x_train.npy', arr = c_x_train)
np.save('../data/npy/cifar10_y_train.npy', arr = c_y_train)
np.save('../data/npy/cifar10_x_test.npy', arr = c_x_test)
np.save('../data/npy/cifar10_y_test.npy', arr = c_y_test)
