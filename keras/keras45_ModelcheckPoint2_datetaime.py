...
from datetime import datetime   # 시간을 같이 저장하기 전에 불러올 것
...
# 원래 이 형식이
# '../data/modelcheckpoint/k45_mnist_{epoch:02d}-{val_loss:.4f}.hdf5'
# 이렇게 저장 된다
# ../data/modelcheckpoint/k45_0127_1018_{epoch:02d}-{val_loss:.4f}.hdf

#=========== 에러 발생 ===========================================#
# 모델이 처음 돌아간 시각으로만 저장되고 갱신이 되지 않음.
# 알아서 해결 ..^^
#=========== 에러 발생 ===========================================#
