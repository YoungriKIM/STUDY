...
#3. 컴파일, 훈련
model.compile(loss='mse', optimizer='adam', metrics=['mae', 'mse']) #매트릭스는 늘 리스트를 씌워줬는데 두개를 넣고 해보자
model.fit([x1_train, x2_train], [y1_train, y2_train], epochs=100, batch_size=1, validation_split=0.2, verbose=2)
