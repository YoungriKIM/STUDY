...
model.fit(x_train, y_train, epochs=100, batch_size=64, validation_split=0.2, verbose=1, callbacks=[stop])
...
# m32_2 pca 1.0이상으로 지정한 파일
# loss:  [2.3010852336883545, 0.11349999904632568]