...
#--------------------------------------------------------------------------------------------------------
# L1.
w1 = tf.get_variable('w1', shape=[3, 3, 1, 32])     # 3, 3 > kernel_size / 1 > chennel, input_dim / 32 > filters, output_dim
...
#--------------------------------------------------------------------------------------------------------
# L2.
w2 = tf.get_variable('w2', shape=[3, 3, 32, 64])     # 3, 3 > kernel_size / 1 > chennel, input_dim >> 이전 레이어의 아웃풋이 해당 레이어의 인풋이 되니까 32 / 32 > filters, output_dim
# == Conv2D(64, (3,3))
...
#--------------------------------------------------------------------------------------------------------
# L3.
w3 = tf.get_variable('w3', shape=[3, 3, 64, 128])     # 3, 3 > kernel_size / 1 > chennel, input_dim >> 이전 레이어의 아웃풋이 해당 레이어의 인풋이 되니까 64 / 32 > filters, output_dim
# == Conv2D(128, (3,3))
