...
def solution_model():
    ...
    lr = ReduceLROnPlateau(factor=0.3, patience=4)
    
    model.fit(train_generator, epochs=1000, steps_per_epoch=20,
    ...
    result = model.evaluate(validation_generator, steps=20)
    print('loss: ', result[0], '\nacc: ', result[1])
